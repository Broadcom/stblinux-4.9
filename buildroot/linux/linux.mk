...
define LINUX_FIXUP_INITRD
	...
	$(if $(BR2_TARGET_ROOTFS_INITRAMFS),
		...
		$(call KCONFIG_ENABLE_OPT,CONFIG_RD_XZ,$(LINUX_DIR)/.config)
		$(foreach opt, CONFIG_RD_GZIP CONFIG_RD_BZIP2 CONFIG_RD_LZMA CONFIG_RD_LZO CONFIG_RD_LZ4,
			$(call KCONFIG_DISABLE_OPT,$(opt),$(LINUX_DIR)/.config)
		)
...
# build process.
define LINUX_INSTALL_IMAGE
	$(INSTALL) -m 0644 -D $(LINUX_IMAGE_PATH) $(1)/$(LINUX_IMAGE_NAME)$(2)
endef
endif
